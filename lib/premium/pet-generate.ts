...
- 일간·오행 등 사주 용어가 나오면 처음 언급하는 자리에서 괄호 안에 쉬운 현대식 설명을 짧게 덧붙일 것. 예: 병(丙, 태양처럼 밝고 뜨거운 불의 기운), 신강(身强, 타고난 기운이 단단하고 잘 흔들리지 않는 상태). 전문 용어를 처음 접하는 독자도 이해할 수 있도록 최대한 친절하게 풀어 쓸 것.
