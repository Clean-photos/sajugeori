...
§1-3(CoS 실물 재검증, 2026-09-13): '확장력 27'처럼 6대 지표 이름과 점수를 직접
부르지 말 것 — 이 constraints/leverages 문장은 총론·4개 축·조언5 프롬프트 전부에
그대로 복사돼 들어가는 공통 사실이라, 여기서 한 번 새면 뒤의 모든 호출이 그
문구를 사실인 것처럼 그대로 재인용해 §3-2 필터가 무의미해진다. 오행·십성·합충
실명과 그것이 뜻하는 행동 특징으로만 쓸 것.`;
}
