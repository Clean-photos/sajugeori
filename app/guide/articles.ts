...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "» 오행은 어떻게 목·화·토·금·수 다섯 가지로 한정되어 확정된 걸까요? 이에 관해서는 여러 의견이 있습니다. 정설은 오행이 단순히 나무·불·흙·금속·물이라는, 자연계에 존재하는 다섯 가지 기본 물질이라는 뜻입니다. 또한 오행에는 '출생·성장·조화·수확·저장'이라는 생명의 순환적 의미와, 오행이 일종의 에너지의 종류라는 의미도 있습니다. 결국 인간이 관찰 가능한 요소 중 가장 중요한 다섯 가지 범주가 자연스럽게 오행으로 정착한 것이 아닐까 주인장은 생각합니다.",
    ],
  },
  {
    slug: "sipseong",
