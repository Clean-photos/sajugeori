...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "그러니 사주를 보는 일을 부끄러워할 필요는 없습니다. 그것은 나약함이 아니라, 불확실한 삶을 조금이라도 이해하고 준비하려는 아주 인간적인 몸짓이니까요. 다만 사주가 미래를 정해 주는 것이 아니라 자신을 돌아보게 하는 참고 자료라는 점만 기억한다면, 그 몸짓은 훨씬 건강한 힘이 됩니다.",
    ],
  },
];
