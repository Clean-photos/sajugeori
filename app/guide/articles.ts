...
export const ARTICLES: Article[] = [
  {
    ...
    cta: { label: "내 사주팔자 무료로 확인하기", href: "/free/saju" },
  },
  {
    slug: "ohaeng",
    title: "오행 해설 — 목화토금수",
    ...
    cta: { label: "내 오행 분포 무료로 보기", href: "/free/saju" },
  },
  {
    slug: "sipseong",
    ...
    cta: { label: "내 십성 무료로 확인하기", href: "/free/saju" },
  },
  {
    ...
    cta: { label: "내 타고난 성격 확인하기", href: "/free/saju" },
  },
  {
    slug: "saju-love",
    title: "사주와 연애 · 궁합",
    ...
    cta: { label: "무료 궁합 보기", href: "/free/compatibility" },
  },
  {
    slug: "how-to-read",
    title: "사주 보는 법 — 첫걸음",
    ...
    cta: { label: "지금 내 사주부터 계산해보기", href: "/free/saju" },
  },
  {
    ...
    cta: { label: "내 오행 정밀 진단 보기", href: "/premium/ohang" },
  },
  {
    slug: "60-ganji-cycle",
    ...
    cta: { label: "내 대운·세운 자세히 보기", href: "/premium/yearly" },
  },
  {
    slug: "fill-water",
  ...
  },
  {
    ...
    cta: { label: "내 사주 무료로 확인하기", href: "/free/saju" },
  },
  {
    ...
    cta: { label: "내 운명 설계도 만나보기", href: "/premium/destiny" },
  },
  {
    ...
    cta: { label: "지금 바로 무료로 확인하기", href: "/free/saju" },
  },
  {
    ...
    cta: { label: "진짜 내 사주로 확인하기", href: "/free/saju" },
  },
  {
    ...
    cta: { label: "태어난 시간까지 정확히 입력하기", href: "/onboarding" },
  },
  {
    ...
    body: [
      ...
      "» 사주가 아주 좋은 사람이 최고의 대운을 맞이했다고 칩시다. 그런데 그 사람이 사주를 믿고 노력을 멈췄다고 생각해 봅시다. 공부를 하던 사람이 중요한 자격시험을 한 달 앞두고 '사주가 좋으니까'라고 생각하며 공부를 등한시하고, 중요한 대회를 앞둔 운동선수가 '시합일엔 사주가 최고니까'라고 생각하며 연습을 반으로 줄였습니다. 좋은 결과가 있을까요? 아니라는 걸 모두 알고 계시겠지요. 결국 사주를 참조하여 더 나은 방향으로 최선의 노력을 기울이며 본인의 인생을 개척해야 하는 것이 우리의 운명입니다.",
    ],
    cta: { label: "내 사주의 강점 자세히 보기", href: "/premium/destiny" },
  },
  {
    ...
    body: [
      ...
      "» 다른 읽을거리인 '사주와 연애·궁합'과 이어지는 이야기입니다. 결론은 사주와 같습니다. 궁합 역시 사주를 기반으로 서로의 상·극을 확인해서 결론짓는 것이니까요. 궁합이 최고지만 본인들이 노력을 하지 않는 관계, 궁합이 좋지 않지만 서로가 끊임없이 소통하고 배려하며 맞춰 가는 관계 — 결국 오래 잘 지속되는 관계는 당사자들의 의지와 행동이 더 큰 요인이라고 봅니다.",
    ],
    cta: { label: "정밀 궁합 분석 보기", href: "/premium/compatibility" },
  },
  {
    ...
    body: [
      ...
      "» 세상에 태어난 생년월일시가 있다면 사주팔자를 세우는 것은 무엇이든 가능합니다. 예를 들어 회사라면 법인번호를 부여받은 시간, 부동산이라면 준공이 완료된 시간 등이겠지요. 저희 사주거리의 프리미엄 코너인 반려동물과의 궁합도 이런 배경으로 만들어졌습니다. 사랑스러운 강아지와 고양이 집사님들에게 소소한 재미를 선사하기를 바랍니다.",
    ],
    cta: { label: "우리 멍냥이와 궁합 보러가기", href: "/premium/pet" },
  },
  {
    ...
    body: [
      ...
      "» 사주를 보러 가고 싶다는 생각이 든다면, 불확실한 무언가를 앞둔 상황인 경우가 대부분입니다. 그리고 인간은 늘 미래라는 불확실함을 마주하고 사는 존재이지요. 미래를 알면 얼마나 좋을까요. 하지만 알 수 없으니, 현재에서 우리는 여러 가능성을 가늠해 볼 수밖에요.",
    ],
    cta: { label: "지금 나도 확인해보기", href: "/free/saju" },
  },
  {
    ...
    body: [
      ...
      "» 사주를 처음 접한 상태에서 가장 먼저 마주하는 벽이 용어입니다. 생소한 단어들은 무슨 뜻인지 유추하기 힘들 정도로 새롭지요. 사주거리 운세에는 사주 용어를 정리해 둔 페이지가 있으니, 궁금하시면 한번쯤 들여다보시기를 추천드립니다.",
    ],
    cta: { label: "무료 결과 다시 보기", href: "/free/saju" },
  },
];
