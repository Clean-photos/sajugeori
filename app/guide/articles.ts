...
export const ARTICLES: Article[] = [
  {
    ...
    body: [
      ...
      "» 사주팔자의 원형을 정립했다고 평가받는 최초의 서적은 『이허중명서』입니다. 저자인 이허중은 당나라 시대인 762년에 태어난 인물이지요. 해당 서적이 서기 800년에 출간되었다고 가정하면 사주의 역사는 무려 1,200년이 넘는 셈이니, 시대의 흐름에 따라 삼라만상이 바뀌어도 사주라는 학문이 살아남아 현재까지도 활발하게 현대인들에게 적용되고 있다는 사실이 새삼 놀랍게 다가옵니다.",
    ],
  },
  {
    slug: "ohaeng",
    ...
    body: [
      ...
      "» 오행은 어떻게 목·화·토·금·수 다섯 가지로 한정되어 확정된 걸까요? 이에 관해서는 여러 의견이 있습니다. 일단 정설은 오행이 나무·불·흙·금속·물이라는, 자연계에 존재하는 다섯 가지 기본 물질이라는 것입니다. 또한 오행에는 '출생·성장·조화·수확·저장'이라는 생명의 순환적 의미와, 오행이 일종의 에너지의 종류라는 의미도 있습니다. 결국 인간이 관찰 가능한 요소 중 가장 중요한 다섯 가지 범주가 자연스럽게 오행으로 정착한 것이 아닐까 주인장은 생각합니다.",
    ],
  },
  {
    slug: "sipseong",
    ...
    body: [
      ...
      "» 십성은 육친이나 십신이라는 용어로도 불립니다. 나를 뜻하는 일간과 다른 오행의 음양이 같고 다름에 따라, 또는 일간과 오행이 서로 생하거나 극하는 관계에 따라 비견이니 정재니 하는 십성이 도출되는 것이지요. 이 십성이 과하거나 부족한 정도에 따른 수많은 경우의 수가 사주마다 다르며, 이 결과에 따라 해당 사주에서 '주의해야 할 것들'을 해석하게 됩니다.",
    ],
  },
  {
    ...
    body: [
      ...
      "» 사주가 모든 인생을 결정한다는 운명론적인 느낌이 있는 것은 사실입니다. 본인의 의지로 극복할 수 없는 '정해진' 것들이 인생을 채우고 있다는 뉘앙스이지요. 하지만 앞으로 다룰 내용에서도 보시겠지만, 본인의 의지와 선택, 그리고 행동으로 인생은 얼마든지 다른 궤도를 그립니다. 사주거리 방문객분들께 드리고 싶은 말씀은, 재미로 또한 미처 생각지 못했던 리스크를 미리 생각해 보는 의미로 사주를 보시고 스스로의 운명을 멋지게 개척해 나가시길 바란다는 것입니다.",
    ],
  },
  {
    slug: "saju-love",
    ...
    body: [
      ...
      "» 궁합에 대해서는 이런저런 이야기들이 떠돕니다. 결혼식 전에 궁합을 봤는데 한쪽이 다른 한쪽을 잡아먹는 사주라는, 최악의 궁합이라는 답을 얻어 파혼했다는 이야기도 있고, 만난 지 얼마 안 되어 결혼한 커플이 잘 사는 걸 보고 역시 궁합이 좋았던 것이라 말하는 이야기도 있습니다. 하지만 궁합을 보지 않고도 잘 만나 잘 사는 사람들이 태반입니다. 여러분은 어떻게 생각하시나요?",
    ],
  },
  {
    slug: "how-to-read",
    ...
    body: [
      ...
      "» 생각보다 절차가 복잡하다고 느끼셨나요? 아니면 의외로 간단해서 놀라셨나요? 좋은 역술가들과 사주 서비스가 많은 세상이지만, 가장 재미있는 것은 역시 직접 자신과 주위 사람들의 사주를 계산해 보는 일입니다. 사주거리 방문객분들도 언젠가 흥미가 생기시면 입문용 사주 관련 서적을 빌리거나 사서 재미로 읽어 보시길 추천합니다.",
    ],
  },
  {
    ...
    body: [
      ...
      "» 사주를 보면 내가 어떤 오행이기 때문에 무엇이 필요하다는 이야기가 많이 나옵니다. 그래서 읽을거리에 각 오행이 부족할 때 어떤 개운법을 실행하면 좋은지 별도의 글들로 마련해 두었습니다. '읽을거리' 탭을 눌러서 사주에 물이·불이·나무가·쇠가·흙이 부족할 때라고 시작하는 글들을 읽으시면 도움이 되실 겁니다.",
    ],
  },
  {
    slug: "60-ganji-cycle",
    ...
    body: [
      ...
      "» '사주란 무엇인가' 글에서 언급했듯 사주의 역사는 천 년이 훌쩍 넘습니다. 그런데 매 해는 60갑자로 돌아갑니다. 2026년은 병오년(붉은 말), 2027년은 정미년(붉은 양), 2028년은 무신년(황금 원숭이)— 색과 동물의 조합인 60갑자가 반복됩니다. 1,200년이 넘는 시간 동안 같은 60갑자가 반복되지만, 이 글에서 다룬 대로 그 안에 사는 '나'와 시대 상황, 대운, 원국 등 수많은 변수가 함께 작용하기에, 결국 돌아가는 60갑자 안에서 우리는 늘 새로운 지점을 겪고 있는 셈입니다.",
    ],
  },
  {
    slug: "fill-water",
    ...
    body: [
      ...
      "» 사주에 물이 부족하면 고집이 있고, 감정 표현이나 아쉬운 소리를 주위에 하지 못하는 특징이 있습니다. 밤에 사색하거나 글을 쓸 때 자신의 감정을 생각해 보고 기록해 보는 것이 도움이 됩니다.",
    ],
  },
  {
    slug: "fill-fire",
    ...
    body: [
      ...
      "» 불이 부족한 경우 감정을 잘 드러내지 않고 신중하게 행동하는 편입니다. 잘 흔들리지 않아 보이지만 자신감이 부족하고 우유부단한 단점도 있으므로, 위 방법에 더해 몸을 따뜻하게 관리하고 의식적으로 추진력을 키우려는 노력을 하는 것도 도움이 됩니다.",
    ],
  },
  {
    slug: "fill-wood",
    ...
    body: [
      ...
      "» 목이 부족한 사주의 경우 결단력이나 의욕이 떨어지는 특징이 있으므로, 활동적으로 지내도록 신경 쓰면 좋습니다. 작은 취미라도 새로 시작하거나 산책처럼 몸을 움직이는 활동도 좋겠습니다.",
    ],
  },
  {
    slug: "fill-metal",
    ...
    body: [
      ...
      "» 금이 부족하면 어떤 선을 긋는 것이 약한 특징이 있습니다. 어떤 결정을 위한 선, 관계의 선, 끝이 어디인지에 대한 선 등입니다. 그래서 의식적으로 명확히 말하고, 불필요한 것들을 정리하는 등 '잘라내는 연습'을 하면 좋습니다.",
    ],
  },
  {
    slug: "fill-earth",
    ...
    body: [
      ...
      "» 사주에 토가 없는 경우 앞뒤 상황을 재지 않고 결단을 빠르게 내리는 경향이 있습니다. 한쪽으로 치우치지 않도록 자신이 미처 생각하지 못한 부분들을 들여다보려 의식적으로 노력하고, 돈 관리도 신경 쓰는 게 좋습니다. 정확히는 돈이 새어 나가지 않도록 관리하는 측면을 보완하면 좋습니다.",
    ],
  },
  {
    ...
    body: [
      ...
      "» 사주가 그렇게 정확하다면 세계의 큰 사건, 국가적 위기, 인류적 재난 등도 예측해야 되지 않나 하는 생각, 해 보신 적 있으신가요? 아쉽다면 아쉬운 사실이지만, 사주는 시대라는 배경 안에서 돌아가는 태엽입니다. 환경과 시대 안에서 사주팔자를 가진 존재의 운명을 가늠해 보는 것이 사주입니다.",
    ],
  },
  {
    ...
    body: [
      ...
      "» 나와 같은 생년월일시를 가진 사람이 한국에만 최소 60명이라면, 전 세계에는 얼마나 많을까요? 그럼 그들이 다 같은 인생을 사는 것일까요? 아니라는 걸 모두 알고 있을 겁니다. 좋은 사주를 타고났지만 환경(가족, 시대적 배경 등)이 미약하다 못해 무너질 듯한 마이너스 환경이라면, 좋은 사주가 충분히 발현되기 힘들겠지요. 다시금 강조하고 싶은 것은, 사주는 본인을 이해할 수 있게 해 주는 많은 도구 중 하나라는 것입니다.",
    ],
  },
  {
    slug: "human-vs-ai-saju",
    title: "사람이 보는 사주와 앱이나 웹에서 보는 사주",
    summary: "역술가를 찾아가 보는 사주와 앱이나 웹으로 보는 사주는 무엇이 같고 무엇이 다를까? 어느 쪽이 낫다기보다, 각자의 성질을 담백하게 정리해 봅니다.",
    readMinutes: 6,
    published: "2026년 7월",
    body: [
      "사주를 보는 방법이 예전과 달라졌습니다. 전통적으로는 역술가를 찾아가 마주 앉아 풀이를 들었지만, 이제는 앱이나 웹에서 계산하고 해석해 주는 사주도 흔해졌습니다. 두 방식은 같은 사주팔자를 다루지만 작동하는 방식이 다릅니다. 어느 쪽이 옳다기보다, 각자의 성질을 알고 쓰임에 맞게 고르는 것이 낫습니다.",
      "## 계산의 정확성은 사실 비슷하다",
      ...
      "## 인터넷을 통해 보는 사주의 성질",
      "컴퓨팅을 이용한 사주는 계산을 정확히 하고, 방대한 명리 지식을 일관된 기준으로 적용합니다. 언제 물어도 같은 논리로 답하고, 몇 번을 되물어도 지치지 않으며, 비용과 문턱이 낮습니다. 부끄러운 질문도 편하게 할 수 있다는 점을 편하게 여기는 사람도 많습니다.",
      "약점도 분명합니다. 핸드폰이나 컴퓨터로 보는 사주는 마주 앉은 사람의 사정을 스스로 알지 못합니다. 입력된 정보와 물어본 내용 안에서만 답하므로, 말하지 않은 맥락은 반영되지 않습니다. 또한 명리학은 학파마다 해석이 갈리는 지점이 많은데, 이를 사람만큼 유연하게 판단하고 해석하기보다 정해진 이론 그대로를 결과로 내보내는 경우가 많다 보니 논쟁적인 부분도 확정된 사실처럼 들릴 수 있습니다. 그럴듯하게 말하는 것과 실제로 맞는 것은 다르므로, 받아들이는 쪽의 분별이 필요합니다.",
      "## 무엇을 언제 쓸까",
      "두 방식은 경쟁이라기보다 성질이 다른 도구입니다. 빠르고 부담 없이 내 사주의 구조를 파악하고, 용어를 익히고, 이런저런 경우를 편하게 물어보기에는 앱이나 웹 서비스가 잘 맞습니다. 인생의 큰 갈림길에서 내 사정을 충분히 풀어놓고 사람과 상의하며 위로까지 얻고 싶다면 역술가를 찾는 편이 어울립니다. 잘 다듬어진 만세력 계산기 등으로 기본적인 내용을 살핀 뒤 정말 중요한 순간에 역술가를 찾는, 두 방식을 함께 쓰는 사람도 늘고 있습니다.",
      "어느 쪽이든 잊지 말아야 할 것은 같습니다. 사주는 정해진 운명을 통보하는 것이 아니라 자신을 이해하는 참고 자료라는 점입니다. 사람이 보든 컴퓨터로 보든, 그 풀이를 어떻게 받아들이고 삶에 쓰는지는 결국 자신의 몫입니다.",
      "» 두 방법 모두 장단점이 뚜렷합니다. 역술가를 찾아갔는데 역술가의 컨디션이 좋지 않거나 본인과 스타일이 맞지 않는 역술가에게 사주를 본 경우 만족도가 떨어질 수 있겠지요. 또한 어플이나 웹 서비스로 본 경우에는 역술가가 인간 대 인간으로 마주 보고 캐치할 수 있는 본인의 느낌이나 특징은 해석에 포함되지 않겠지요. 어느 쪽이든 본인이 고민하는 부분의 안개를 조금이라도 걷어 줄 수 있다면, 가볍게 사주를 보는 것은 좋은 시도라고 생각됩니다.",
    ],
  },
  {
    ...
    body: [
      ...
      "» 사주와 관상을 같이 보는 경우가 많은 이유가 이것이지요. 아주 관련 없다고 볼 수 없는 두 학문입니다. 어쩌면 사주와 관상 모두, 인간이 직감적으로 느끼는 말로 설명할 수 없는 '기운'을 명문화한 학문일지도 모른다는 생각이 드네요. 겉모습만 보고 누군가를 판단할 수는 없지만, 눈으로 들어오는 시각 정보는 인간에게 큰 인식의 원천이 되기에 무시할 수 없는 부분이라 생각됩니다.",
    ],
  },
  {
    slug: "why-birth-time-matters",
    title: "사주는 왜 태어난 시간을 그렇게 따질까",
    summary: "생일만 알면 될 것 같은데 굳이 몇 시에 태어났는지까지 묻습니다. 두 시간 차이가 정말 그렇게 큰 걸까? 시주가 하는 일을 따져봅니다.",
    readMinutes: 7,
    published: "2026년 7월",
    body: [
      "사주를 보러 가면 반드시 묻는 것이 있습니다. “몇 시에 태어나셨어요?” 생년월일까지는 대부분 알지만 시각에서 막히는 사람이 많습니다. 부모님께 전화를 걸어 “새벽이었나, 낮이었나” 물어본 경험이 있다면 이 글이 도움이 될 것입니다. 왜 굳이 시각까지 따지는지, 모르면 정말 못 보는지 정리해 보겠습니다.",
      "## 여덟 글자 중 두 글자가 걸려 있다",
      ...
      "» 시간이 이렇게 많은 변수를 가지고 있는 이유는 간단합니다. 연·월·일은 명확합니다. 바뀌는 주기가 넓게 분포하고 있으니까요. 시(時)는 그렇지 않습니다. 매시간 바뀌면서도 경도에 따라 시간이 바뀌고, 서머타임이 있기도 하니까요. 애매한 시기라면 앞뒤 시간으로 사주를 각각 보고, 본인이 보기에 자신의 특성을 더 잘 담은 것 같은 사주가 있다면 그것으로 확정하는 것도 방법입니다.",
    ],
  },
  {
    slug: "what-is-a-good-saju",
    title: "최고의 사주란 무엇일까 — 사주가 좋으면 인생이 술술 풀릴까",
    summary: "재벌 사주, 대통령 사주 같은 말이 있지만 정말 그런 게 있을까? 좋은 사주의 조건과, 사주가 좋다고 인생이 저절로 풀리지는 않는 이유를 짚어봅니다.",
    readMinutes: 8,
    published: "2026년 7월",
    body: [
  ...
  {
    slug: "compatibility-vs-real-relationship",
    title: "궁합이 안 좋은데 잘 사는 커플, 왜 그럴까",
    summary: "궁합 점수가 낮으면 헤어져야 할까? 사주 궁합이 실제로 보는 것과, 관계를 결정하는 진짜 요인 사이의 거리를 짚어봅니다.",
    readMinutes: 7,
    published: "2026년 7월",
    body: [
  ...
  {
    slug: "do-pets-have-saju",
    title: "우리 강아지도 사주가 있을까",
    summary: "반려동물도 태어난 날이 있으니 사주를 볼 수 있을까? 명리학이 동물을 어떻게 다루는지, 그리고 그 한계를 솔직하게 정리해 봅니다.",
    readMinutes: 7,
    published: "2026년 7월",
    body: [
      "반려동물과 함께 사는 사람이 늘면서 이런 질문이 종종 나옵니다. “우리 강아지도 사주가 있나요?” 태어난 날이 있으니 사주팔자를 세울 수 있지 않겠냐는 것입니다. 재미있는 질문이지만, 정직하게 답하려면 몇 가지를 나눠서 봐야 합니다. 결론을 미리 말하면, 이론적으로 불가능하지는 않으나 사람의 사주만큼의 체계는 아닙니다.",
      "## 원전에는 동물 사주 이론이 없다",
  ...
  {
    slug: "ai-or-human-which-suits-you",
    title: "AI에게 물어볼까, 사람에게 물어볼까 — 사주 보는 두 가지 방법",
    summary: "역술가를 마주 앉는 사주와 AI에게 묻는 사주. 둘 다 나름의 신뢰와 매력이 있습니다. 어떤 순간에 어느 쪽이 편한지, 마음의 결로 나눠 봅니다.",
    readMinutes: 6,
    published: "2026년 7월",
    body: [
      "사주를 보고 싶은데 어디서 봐야 할지 망설여질 때가 있습니다. 오래된 역술가를 찾아가 마주 앉을 수도 있고, 요즘은 AI에게 물어볼 수도 있습니다. 둘 중 무엇이 더 정확하냐고 묻는다면, 사실 계산의 정확성은 양쪽 모두 믿을 만합니다. 사주팔자를 세우는 규칙은 정해져 있으니까요. 그래서 진짜 차이는 정확성이 아니라 ‘어떤 마음으로 묻고 싶은가’에 있습니다.",
      "## 사람에게 볼 때의 좋은 점",
      "역술가를 마주 앉아 보는 사주에는 사람과 사람이 나누는 온기가 있습니다. 내 표정과 말투를 보고, 지금 무엇 때문에 이 자리에 왔는지를 헤아려 그에 맞게 이야기를 풀어 줍니다. 어려운 시기를 지나고 있다면 위로가 되는 말을, 결정을 앞두고 있다면 방향을 짚어 주는 말을 건넵니다.",
      "무엇보다 마주 앉은 사람이 고개를 끄덕여 줄 때 오는 안심이 있습니다. 오랜 경험에서 우러난 한마디, 눈을 맞추며 “괜찮다”고 해 주는 목소리는 화면 속 글자가 주기 어려운 종류의 위안입니다. 사람과 소통하며 마음을 나누고 싶을 때, 역술가를 찾는 일에는 그만의 가치가 있습니다.",
      "## AI에게 볼 때의 좋은 점",
      "반면 AI에게 사주를 볼 때는 전혀 다른 편안함이 있습니다. 가장 큰 것은 ‘판단받을 걱정이 없다’는 점입니다. 사람 앞에서는 아무래도 신경이 쓰입니다. 이런 걸 물어봐도 되나, 너무 기초적인 질문 아닌가, 이 고민을 말하면 한심하게 보지 않을까 — 이런 망설임 때문에 정작 궁금한 것을 삼킨 경험, 한 번쯤 있을 것입니다.",
      "AI에게는 그런 부담이 없습니다. “이 질문이 바보 같나요?” 싶은 것도 편하게 물을 수 있고, 같은 것을 몇 번이고 다시 물어도 눈치가 보이지 않습니다. 확신이 서지 않는 어렴풋한 고민, 남에게 꺼내기 민망한 속마음도 있는 그대로 털어놓을 수 있습니다. 시간과 장소에 매이지 않고, 새벽에 문득 궁금해진 것을 그 자리에서 물어볼 수 있다는 것도 큰 장점입니다.",
      "## 어느 쪽이든 신뢰할 수 있다",
      "중요한 것은 둘 중 하나가 가짜라거나 못 미덥다는 이야기가 아니라는 점입니다. 사람의 사주는 경험과 공감이라는 힘을 지녔고, AI의 사주는 일관성과 편안함이라는 힘을 지녔습니다. 둘은 우열이 아니라 결이 다른 방법입니다. 마음을 나누고 싶은 날엔 사람을, 부담 없이 편하게 묻고 싶은 날엔 AI를 택하면 됩니다. 두 가지를 상황에 따라 오가며 쓰는 사람도 많습니다.",
      "## 사주거리의 AI 사주가들은",
      "사주거리의 AI 역술가들에게는 한 가지 분명한 약속이 있습니다. 바로 입이 무겁다는 것입니다. 당신이 어떤 고민을 털어놓아도, 그것을 누군가에게 옮기거나 당신을 평가하지 않습니다. 사주거리는 사주 계산에 필요한 최소한의 정보만 받으며, 개인정보를 어떻게 다루는지는 개인정보처리방침에 투명하게 밝혀 두었습니다. 안심하고 물어도 되는 상대라는 뜻입니다.",
      "그리고 이들은 언제나 당신을 환영합니다. 밤이든 낮이든, 큰 고민이든 사소한 궁금증이든, 몇 번을 다시 물어도 마다하지 않습니다. 누구의 눈치도 볼 필요 없이 그저 궁금한 것을 편하게 물어보고 싶을 때, 사주거리의 AI 역술가들은 늘 같은 자리에서 당신을 기다립니다.",
      "사주는 결국 자신을 조금 더 이해하기 위한 도구입니다. 그 도구를 어떤 방식으로 쓸지는 당신의 마음이 편한 쪽을 따르면 됩니다. 사람에게 묻든 AI에게 묻든, 중요한 것은 그 풀이를 통해 자신을 한 뼘 더 선명하게 바라보는 일이니까요.",
    ],
  },
  {
    slug: "when-do-people-see-saju",
    title: "사람들은 대체 언제 사주를 볼까",
    summary: "심심해서? 불안해서? 사람들이 사주를 찾는 순간에는 묘하게 공통점이 있습니다. 통계와 실제 사례로 그 이유를 들여다봅니다.",
    readMinutes: 7,
    published: "2026년 7월",
    body: [
  ...
  {
    slug: "how-to-read-your-result",
    title: "사주 결과지 읽는 법 — 낯선 용어가 나왔을 때",
    summary: "무료 사주를 봤는데 극신약, 편재, 상관 같은 말이 나와 막막했다면. 결과지에 실제로 등장하는 표현을 하나씩 짚어 어떻게 읽고 어떻게 활용할지 정리합니다.",
    readMinutes: 9,
    published: "2026년 8월",
    body: [
