...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "## 무엇을 언제 쓸까",
      "두 방식은 경쟁이라기보다 성질이 다른 도구입니다. 빠르고 부담 없이 내 사주의 구조를 파악하고, 용어를 익히고, 이런저런 경우를 편하게 물어보기에는 앱이나 웹 서비스가 잘 맞습니다. 인생의 큰 갈림길에서 내 사정을 충분히 풀어놓고 사람과 상의하며 위로까지 얻고 싶다면 역술가를 찾는 편이 어울립니다. AI로 기본기를 익힌 뒤 정말 중요한 순간에 역술가를 찾는, 두 방식을 함께 쓰는 사람도 늘고 있습니다.",
