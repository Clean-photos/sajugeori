...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "## 이 방법을 어떻게 받아들일까",
      "짚어 둘 것이 있습니다. 색·방위·맛의 배속 자체는 오방색(五方色)과 오미(五味)라는 전통 체계에 근거한 표준 분류입니다. 반면 그 배속을 생활에 적용해 운을 보완한다는 개운법(開運法)은, 명리와 풍수 전통 안에서 오래 쓰여 온 방법이긴 하나 과학적으로 검증된 바는 없습니다. 술사와 유파에 따라 처방도 조금씩 다릅니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "## 이 방법을 어떻게 받아들일까",
      "색·방위·맛의 배속 자체는 오방색(五方色)과 오미(五味)라는 전통 체계에 근거한 표준 분류입니다. 반면 그 배속을 생활에 적용해 운을 보완한다는 개운법(開運法)은, 명리와 풍수 전통 안에서 오래 쓰여 온 방법이긴 하나 과학적으로 검증된 바는 없습니다. 술사와 유파에 따라 처방도 조금씩 다릅니다.",
